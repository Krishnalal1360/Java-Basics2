...
public class P6 {
  public static void main(String[] args) {
    ...
    System.out.println("In Upper Triangular Matrix the elements on left diagonal and above it should be non-zero.");
    System.out.println("The elements below it should be zero.");
